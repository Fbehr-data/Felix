...
the arguments needed are passed form the main script gammaGUI.py in nested lists
...
if a corresponding parameter file exists, the parameter values of this file are entered into the form, otherwise the default values (passed from class Main of script gammaGUI.py)
are entered
...
from gammaGUI_301015.ancillary import Environment, makeform, execute, ReadPar
