...
from gammaGUI_301015.dialog import Dialog
from gammaGUI_301015.fileQuery import FileQuery
from gammaGUI_301015.ancillary import Environment
...
class Main(Frame):
    def __init__(self, *args, **kwargs):
        ...
        # calibration
        # args_cal_slc = [["SLC calibration", sys.executable, "cal_slc.py"], [], [], []]

        # SLC coregistration
        args_cor = [["SLC coregistration", sys.executable, "coreg.py"], ["primary SLC", "secondary SLC"], ["algorithm", "rwin", "azwin", "n_ovr", "nr", "npoly"], [1, 256, 256, 1, 64, 3]]
        args_cor2 = [["SLC coregistration (batched)", sys.executable, "coreg_batch.py"], ["image list"], ["algorithm", "rwin", "azwin", "n_ovr", "nr", "npoly"], [1, 256, 256, 1, 64, 3]]
        ...
        args_srtm_prep = [["srtm preparation", sys.executable, "srtm_preparation.py"], ["SRTM archive"],
                    ["targetres", "utm"], [20, True]]

        args_dem = [["dem preparation", sys.executable, "dem_preparation.py"], ["DEM"], [], []]

        args_geo = [["geocoding", sys.executable, "geocoding.py"], ["DEM"],
                    ["frame", "interp_mode", "rwin", "azwin", "thres_snr", "n_ovr", "npoly", "n_range", "interp_mode_intensity", "interp_mode_coherence", "topographic normalization"],
                    [8, 2, 256, 256, 7.0, 2, 3, 64, 2, 2, True]]
        # #######################################################################################################
        # LAT
...
if __name__ == "__main__":
    ...
    tkimage = ImageTk.PhotoImage(Image.open("background.jpg"))
